...
RobotState RobotState::from_franka(
    const franka::RobotState &franka_robot_state, std::optional<Vector7d> dq_est, std::optional<Vector7d> ddq_est,
    std::optional<Twist> O_dP_EE_est, std::optional<TwistAcceleration> O_ddP_EE_est, std::optional<double> delbow_est,
...
RobotState RobotState::from_franka(
    const franka::RobotState &franka_robot_state, const Jacobian &ee_jacobian, const Vector7d &dq_est,
  ...
  return RobotState::from_franka(franka_robot_state, dq_est, ddq_est, O_dp_EE_est, O_ddp_EE_est, dq_est[2], ddq_est[2]);
}
