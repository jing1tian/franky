...
void bind_robot(py::module &m) {
  ...
  py::class_<Gripper>(m, "Gripper")
      ...
      .def_property_readonly("is_grasped", py::cpp_function(&Gripper::is_grasped, py::call_guard<py::gil_scoped_release>()))
      .def_property_readonly("max_width", py::cpp_function(&Gripper::max_width, py::call_guard<py::gil_scoped_release>()));
  ...
  py::class_<Robot>(m, "_RobotInternal")
      ...
      .def_property_readonly("has_errors", py::cpp_function(&Robot::hasErrors, py::call_guard<py::gil_scoped_release>()))
      .def_property_readonly("current_pose", py::cpp_function(&Robot::currentPose, py::call_guard<py::gil_scoped_release>()))
      .def_property_readonly("current_cartesian_velocity", py::cpp_function(&Robot::currentCartesianVelocity, py::call_guard<py::gil_scoped_release>()))
      .def_property_readonly("current_cartesian_state", py::cpp_function(&Robot::currentCartesianState, py::call_guard<py::gil_scoped_release>()))
      .def_property_readonly("current_joint_state", py::cpp_function(&Robot::currentJointState, py::call_guard<py::gil_scoped_release>()))
      .def_property_readonly("current_joint_velocities", py::cpp_function(&Robot::currentJointVelocities, py::call_guard<py::gil_scoped_release>()))
      .def_property_readonly("current_joint_positions", py::cpp_function(&Robot::currentJointPositions, py::call_guard<py::gil_scoped_release>()))
