...
class TwistAcceleration {
 public:
  ...
  /**
   * @brief Get the vector representation of the twist acceleration. It consists of the linear and angular velocities.
   *
  ...
  /**
   * @brief Transform the frame of the twist acceleration by applying the given affine transform.
   *
  ...
  /**
   * @brief Transform the frame of the twist acceleration by applying the given rotation.
   *
  ...
  /**
   * @brief Propagate the twist acceleration through a link with the given translation. Hence, suppose this twist
   * acceleration is the twist acceleration of a frame A, then this function computes the twist acceleration of a
   * frame B that is rigidly attached to frame A by a link with the given translation: B = A + T, where T is the
   * translation.
   *
   * @param link_translation        The translation of the link (A to B). Must be in the same reference frame as this
   *                                twist acceleration.
   * @param base_angular_velocity   Angular velocity of the base frame (A) [rad/s]. Must be in the same reference frame
   *                                as this twist acceleration.
